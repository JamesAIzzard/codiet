...
class IngredientEditorCtrl(gui.CodietCtrl):
    def __init__(self, *args, **kwargs):
        ...
        gui.main.cmb_add_items_once(self.view.cmb_cost_units, mass_units)
        gui.main.cmb_add_items_once(self.view.cmb_dens_mass_units, mass_units)
        gui.main.cmb_add_items_once(self.view.cmb_dens_vol_units, vol_units)
        gui.main.cmb_add_items_once(self.view.cmb_mass_pieces_units, mass_units)
