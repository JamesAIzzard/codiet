...
class TestCreateGlobalUnit(DatabaseTestCase):
    ...
    def test_create_global_unit_creates_unit(self):
        ...
        self.assertIn('grams', aliases)
        aliases = self.repository.read_global_unit_aliases(kg_id)
        self.assertIn('kilograms', aliases)
...
class TestCreateIngredientNutrientQuantity(DatabaseTestCase):
    ...
    def test_create_ingredient_nutrient_quantity_creates_nutrient_quantity(self):
        ...
        self.assertEqual(ingredient_ntr_quantities[nutrient_id]["ing_grams_value"], 100)
...
class TestUpdateIngredientNutrientQuantity(DatabaseTestCase):
    ...
    def test_update_ingredient_nutrient_quantity_updates_nutrient_quantity(self):
        ...
        # Check the ingredient grams quantity value is correct
        self.assertEqual(ing_nutr_quantities[nutrient_id]["ing_grams_value"], 100)
        # Check the nutrient mass unit is correct
