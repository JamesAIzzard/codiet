...
class TestBidirectionalMap(unittest.TestCase):
    ...
    def test_constructor_default(self):
        """
        Test the default constructor behavior of BidirectionalMap.
    ...
    def test_constructor_with_lists_default_one_to_one(self):
        ...
        bm = BidirectionalMap(from_list=from_list, to_list=to_list)
    ...
    def test_constructor_with_lists_many_to_many(self):
        ...
        bm = BidirectionalMap(from_list=from_list, to_list=to_list, one_to_one=False)
    ...
    def test_constructor_with_unequal_lists(self):
        ...
        with self.assertRaises(ValueError):
            BidirectionalMap(from_list=from_list, to_list=to_list)
