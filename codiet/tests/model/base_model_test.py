...
class BaseModelTest(TestCase):
    ...
    def setUp(self) -> None:
        ...
        """
        self._initialise_essential_fixtures()
        self._domain_service = self._build_domain_service()

    def _initialise_essential_fixtures(self):
    ...
    def _build_domain_service(self):
