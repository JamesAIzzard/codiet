...
class SingletonRegistry():
    ...
    def set_unit_builder(self, builder: Callable[[str], 'Unit']) -> None:
        self._unit_loader = builder
    ...
    def set_nutrient_builder(self, builder: Callable[[str], 'Nutrient']) -> None:
        self._nutrient_loader = builder
