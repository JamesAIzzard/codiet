...
class EntityServeTimeWindow(StoredRefEntity):
    def __init__(
            self,
            parent_id: int,
        ...
        super().__init__(primary_entity_id=parent_id, *args, **kwargs)
    ...
    def is_subset_of(self, other: 'EntityServeTimeWindow') -> bool:
    ...
    def is_superset_of(self, other: 'EntityServeTimeWindow') -> bool:
